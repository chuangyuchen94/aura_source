...
linear_regression = MYLinearRregression(learning_rate=learning_rate, iteration_num=num_iterations)

linear_regression.fit(x_train, y_train)
theta = linear_regression.get_best_params()
cost_history = linear_regression.get_loss_values()
